...
{
    namespace DirectX_11_和_XAML_应用_XamlTypeInfo
    {
...
[::Windows::Foundation::Metadata::DefaultOverload]
::Windows::UI::Xaml::Markup::IXamlType^ ::DirectX_11_和_XAML_应用::DirectX_11_和_XAML_应用_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
    return Provider->GetXamlTypeByType(type);
}

::Windows::UI::Xaml::Markup::IXamlType^ ::DirectX_11_和_XAML_应用::DirectX_11_和_XAML_应用_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(Platform::String^ fullName)
{
    return Provider->GetXamlTypeByName(fullName);
}

Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::DirectX_11_和_XAML_应用::DirectX_11_和_XAML_应用_XamlTypeInfo::XamlMetaDataProvider::GetXmlnsDefinitions()
{
    return ref new Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>(0);
}

::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider^ ::DirectX_11_和_XAML_应用::DirectX_11_和_XAML_应用_XamlTypeInfo::XamlMetaDataProvider::Provider::get()
{
